...
{
    public class ServiceHubForm : Form
    {
        ...
        {
            this.Text = "Service Management Hub";
            ...
            buttons[0].Click += (s, e) =>
            {
                var integrationForm = new ServiceIntegrationForm();
            ...
            buttons[1].Click += (s, e) =>
            {
                var listingForm = new ServiceListingForm();
            ...
            // Performance Reports (to be implemented)
            buttons[3].Click += (s, e) =>
            {
                var performanceReports = new PerformanceReportsForm();
                performanceReports.ShowDialog();
            };
